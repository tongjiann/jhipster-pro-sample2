...
export class ChartGanttComponent implements OnInit {
  ...
  constructor(private lazy: LazyService, private msg: NzMessageService, private cdr: ChangeDetectorRef) {}
  ...
  ngOnInit(): void {
    this.lazy
      .load(['https://unpkg.com/frappe-gantt@0.3.0/dist/frappe-gantt.css', 'https://unpkg.com/frappe-gantt@0.3.0/dist/frappe-gantt.min.js'])
      .then(() => this.init());
  }
}
