...
class SmsConfigResourceIT {
    ...
    void createSmsConfig() throws Exception {
        ...
        assertThat(testSmsConfig.getRemovedAt()).isEqualTo(DEFAULT_REMOVED_AT);
    }
    ...
    @Test
    @Transactional
    void getAllSmsConfigsByRemovedAtIsEqualToSomething() throws Exception {
        // Initialize the database
        smsConfigRepository.insert(smsConfig);

        // Get all the smsConfigList where removedAt equals to DEFAULT_REMOVED_AT
        defaultSmsConfigShouldBeFound("removedAt.equals=" + DEFAULT_REMOVED_AT);

        // Get all the smsConfigList where removedAt equals to UPDATED_REMOVED_AT
        defaultSmsConfigShouldNotBeFound("removedAt.equals=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllSmsConfigsByRemovedAtIsNotEqualToSomething() throws Exception {
        // Initialize the database
        smsConfigRepository.insert(smsConfig);

        // Get all the smsConfigList where removedAt not equals to DEFAULT_REMOVED_AT
        defaultSmsConfigShouldNotBeFound("removedAt.notEquals=" + DEFAULT_REMOVED_AT);

        // Get all the smsConfigList where removedAt not equals to UPDATED_REMOVED_AT
        defaultSmsConfigShouldBeFound("removedAt.notEquals=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllSmsConfigsByRemovedAtIsInShouldWork() throws Exception {
        // Initialize the database
        smsConfigRepository.insert(smsConfig);

        // Get all the smsConfigList where removedAt in DEFAULT_REMOVED_AT or UPDATED_REMOVED_AT
        defaultSmsConfigShouldBeFound("removedAt.in=" + DEFAULT_REMOVED_AT + "," + UPDATED_REMOVED_AT);

        // Get all the smsConfigList where removedAt equals to UPDATED_REMOVED_AT
        defaultSmsConfigShouldNotBeFound("removedAt.in=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllSmsConfigsByRemovedAtIsNullOrNotNull() throws Exception {
        // Initialize the database
        smsConfigRepository.insert(smsConfig);

        // Get all the smsConfigList where removedAt is not null
        defaultSmsConfigShouldBeFound("removedAt.specified=true");

        // Get all the smsConfigList where removedAt is null
        defaultSmsConfigShouldNotBeFound("removedAt.specified=false");
    }

    @Test
    @Transactional
    void getAllSmsConfigsByRemovedAtIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        smsConfigRepository.insert(smsConfig);

        // Get all the smsConfigList where removedAt is greater than or equal to DEFAULT_REMOVED_AT
        defaultSmsConfigShouldBeFound("removedAt.greaterThanOrEqual=" + DEFAULT_REMOVED_AT);

        // Get all the smsConfigList where removedAt is greater than or equal to UPDATED_REMOVED_AT
        defaultSmsConfigShouldNotBeFound("removedAt.greaterThanOrEqual=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllSmsConfigsByRemovedAtIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        smsConfigRepository.insert(smsConfig);

        // Get all the smsConfigList where removedAt is less than or equal to DEFAULT_REMOVED_AT
        defaultSmsConfigShouldBeFound("removedAt.lessThanOrEqual=" + DEFAULT_REMOVED_AT);

        // Get all the smsConfigList where removedAt is less than or equal to SMALLER_REMOVED_AT
        defaultSmsConfigShouldNotBeFound("removedAt.lessThanOrEqual=" + SMALLER_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllSmsConfigsByRemovedAtIsLessThanSomething() throws Exception {
        // Initialize the database
        smsConfigRepository.insert(smsConfig);

        // Get all the smsConfigList where removedAt is less than DEFAULT_REMOVED_AT
        defaultSmsConfigShouldNotBeFound("removedAt.lessThan=" + DEFAULT_REMOVED_AT);

        // Get all the smsConfigList where removedAt is less than UPDATED_REMOVED_AT
        defaultSmsConfigShouldBeFound("removedAt.lessThan=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllSmsConfigsByRemovedAtIsGreaterThanSomething() throws Exception {
        // Initialize the database
        smsConfigRepository.insert(smsConfig);

        // Get all the smsConfigList where removedAt is greater than DEFAULT_REMOVED_AT
        defaultSmsConfigShouldNotBeFound("removedAt.greaterThan=" + DEFAULT_REMOVED_AT);

        // Get all the smsConfigList where removedAt is greater than SMALLER_REMOVED_AT
        defaultSmsConfigShouldBeFound("removedAt.greaterThan=" + SMALLER_REMOVED_AT);
    }
    ...
    void putNewSmsConfig() throws Exception {
        ...
        assertThat(testSmsConfig.getRemovedAt()).isEqualTo(UPDATED_REMOVED_AT);
    }
