...
class ApiPermissionResourceIT {
    ...
    void createApiPermission() throws Exception {
        ...
        assertThat(testApiPermission.getRemovedAt()).isEqualTo(DEFAULT_REMOVED_AT);
    }
    ...
    @Test
    @Transactional
    void getAllApiPermissionsByRemovedAtIsEqualToSomething() throws Exception {
        // Initialize the database
        apiPermissionRepository.insert(apiPermission);

        // Get all the apiPermissionList where removedAt equals to DEFAULT_REMOVED_AT
        defaultApiPermissionShouldBeFound("removedAt.equals=" + DEFAULT_REMOVED_AT);

        // Get all the apiPermissionList where removedAt equals to UPDATED_REMOVED_AT
        defaultApiPermissionShouldNotBeFound("removedAt.equals=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllApiPermissionsByRemovedAtIsNotEqualToSomething() throws Exception {
        // Initialize the database
        apiPermissionRepository.insert(apiPermission);

        // Get all the apiPermissionList where removedAt not equals to DEFAULT_REMOVED_AT
        defaultApiPermissionShouldNotBeFound("removedAt.notEquals=" + DEFAULT_REMOVED_AT);

        // Get all the apiPermissionList where removedAt not equals to UPDATED_REMOVED_AT
        defaultApiPermissionShouldBeFound("removedAt.notEquals=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllApiPermissionsByRemovedAtIsInShouldWork() throws Exception {
        // Initialize the database
        apiPermissionRepository.insert(apiPermission);

        // Get all the apiPermissionList where removedAt in DEFAULT_REMOVED_AT or UPDATED_REMOVED_AT
        defaultApiPermissionShouldBeFound("removedAt.in=" + DEFAULT_REMOVED_AT + "," + UPDATED_REMOVED_AT);

        // Get all the apiPermissionList where removedAt equals to UPDATED_REMOVED_AT
        defaultApiPermissionShouldNotBeFound("removedAt.in=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllApiPermissionsByRemovedAtIsNullOrNotNull() throws Exception {
        // Initialize the database
        apiPermissionRepository.insert(apiPermission);

        // Get all the apiPermissionList where removedAt is not null
        defaultApiPermissionShouldBeFound("removedAt.specified=true");

        // Get all the apiPermissionList where removedAt is null
        defaultApiPermissionShouldNotBeFound("removedAt.specified=false");
    }

    @Test
    @Transactional
    void getAllApiPermissionsByRemovedAtIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        apiPermissionRepository.insert(apiPermission);

        // Get all the apiPermissionList where removedAt is greater than or equal to DEFAULT_REMOVED_AT
        defaultApiPermissionShouldBeFound("removedAt.greaterThanOrEqual=" + DEFAULT_REMOVED_AT);

        // Get all the apiPermissionList where removedAt is greater than or equal to UPDATED_REMOVED_AT
        defaultApiPermissionShouldNotBeFound("removedAt.greaterThanOrEqual=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllApiPermissionsByRemovedAtIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        apiPermissionRepository.insert(apiPermission);

        // Get all the apiPermissionList where removedAt is less than or equal to DEFAULT_REMOVED_AT
        defaultApiPermissionShouldBeFound("removedAt.lessThanOrEqual=" + DEFAULT_REMOVED_AT);

        // Get all the apiPermissionList where removedAt is less than or equal to SMALLER_REMOVED_AT
        defaultApiPermissionShouldNotBeFound("removedAt.lessThanOrEqual=" + SMALLER_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllApiPermissionsByRemovedAtIsLessThanSomething() throws Exception {
        // Initialize the database
        apiPermissionRepository.insert(apiPermission);

        // Get all the apiPermissionList where removedAt is less than DEFAULT_REMOVED_AT
        defaultApiPermissionShouldNotBeFound("removedAt.lessThan=" + DEFAULT_REMOVED_AT);

        // Get all the apiPermissionList where removedAt is less than UPDATED_REMOVED_AT
        defaultApiPermissionShouldBeFound("removedAt.lessThan=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllApiPermissionsByRemovedAtIsGreaterThanSomething() throws Exception {
        // Initialize the database
        apiPermissionRepository.insert(apiPermission);

        // Get all the apiPermissionList where removedAt is greater than DEFAULT_REMOVED_AT
        defaultApiPermissionShouldNotBeFound("removedAt.greaterThan=" + DEFAULT_REMOVED_AT);

        // Get all the apiPermissionList where removedAt is greater than SMALLER_REMOVED_AT
        defaultApiPermissionShouldBeFound("removedAt.greaterThan=" + SMALLER_REMOVED_AT);
    }
    ...
    void putNewApiPermission() throws Exception {
        ...
        assertThat(testApiPermission.getRemovedAt()).isEqualTo(UPDATED_REMOVED_AT);
    }
