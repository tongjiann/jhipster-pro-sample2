...
class ResourceCategoryResourceIT {
    ...
    void createResourceCategory() throws Exception {
        ...
        assertThat(testResourceCategory.getRemovedAt()).isEqualTo(DEFAULT_REMOVED_AT);
    }
    ...
    @Test
    @Transactional
    void getAllResourceCategoriesByRemovedAtIsEqualToSomething() throws Exception {
        // Initialize the database
        resourceCategoryRepository.insert(resourceCategory);

        // Get all the resourceCategoryList where removedAt equals to DEFAULT_REMOVED_AT
        defaultResourceCategoryShouldBeFound("removedAt.equals=" + DEFAULT_REMOVED_AT);

        // Get all the resourceCategoryList where removedAt equals to UPDATED_REMOVED_AT
        defaultResourceCategoryShouldNotBeFound("removedAt.equals=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllResourceCategoriesByRemovedAtIsNotEqualToSomething() throws Exception {
        // Initialize the database
        resourceCategoryRepository.insert(resourceCategory);

        // Get all the resourceCategoryList where removedAt not equals to DEFAULT_REMOVED_AT
        defaultResourceCategoryShouldNotBeFound("removedAt.notEquals=" + DEFAULT_REMOVED_AT);

        // Get all the resourceCategoryList where removedAt not equals to UPDATED_REMOVED_AT
        defaultResourceCategoryShouldBeFound("removedAt.notEquals=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllResourceCategoriesByRemovedAtIsInShouldWork() throws Exception {
        // Initialize the database
        resourceCategoryRepository.insert(resourceCategory);

        // Get all the resourceCategoryList where removedAt in DEFAULT_REMOVED_AT or UPDATED_REMOVED_AT
        defaultResourceCategoryShouldBeFound("removedAt.in=" + DEFAULT_REMOVED_AT + "," + UPDATED_REMOVED_AT);

        // Get all the resourceCategoryList where removedAt equals to UPDATED_REMOVED_AT
        defaultResourceCategoryShouldNotBeFound("removedAt.in=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllResourceCategoriesByRemovedAtIsNullOrNotNull() throws Exception {
        // Initialize the database
        resourceCategoryRepository.insert(resourceCategory);

        // Get all the resourceCategoryList where removedAt is not null
        defaultResourceCategoryShouldBeFound("removedAt.specified=true");

        // Get all the resourceCategoryList where removedAt is null
        defaultResourceCategoryShouldNotBeFound("removedAt.specified=false");
    }

    @Test
    @Transactional
    void getAllResourceCategoriesByRemovedAtIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        resourceCategoryRepository.insert(resourceCategory);

        // Get all the resourceCategoryList where removedAt is greater than or equal to DEFAULT_REMOVED_AT
        defaultResourceCategoryShouldBeFound("removedAt.greaterThanOrEqual=" + DEFAULT_REMOVED_AT);

        // Get all the resourceCategoryList where removedAt is greater than or equal to UPDATED_REMOVED_AT
        defaultResourceCategoryShouldNotBeFound("removedAt.greaterThanOrEqual=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllResourceCategoriesByRemovedAtIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        resourceCategoryRepository.insert(resourceCategory);

        // Get all the resourceCategoryList where removedAt is less than or equal to DEFAULT_REMOVED_AT
        defaultResourceCategoryShouldBeFound("removedAt.lessThanOrEqual=" + DEFAULT_REMOVED_AT);

        // Get all the resourceCategoryList where removedAt is less than or equal to SMALLER_REMOVED_AT
        defaultResourceCategoryShouldNotBeFound("removedAt.lessThanOrEqual=" + SMALLER_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllResourceCategoriesByRemovedAtIsLessThanSomething() throws Exception {
        // Initialize the database
        resourceCategoryRepository.insert(resourceCategory);

        // Get all the resourceCategoryList where removedAt is less than DEFAULT_REMOVED_AT
        defaultResourceCategoryShouldNotBeFound("removedAt.lessThan=" + DEFAULT_REMOVED_AT);

        // Get all the resourceCategoryList where removedAt is less than UPDATED_REMOVED_AT
        defaultResourceCategoryShouldBeFound("removedAt.lessThan=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllResourceCategoriesByRemovedAtIsGreaterThanSomething() throws Exception {
        // Initialize the database
        resourceCategoryRepository.insert(resourceCategory);

        // Get all the resourceCategoryList where removedAt is greater than DEFAULT_REMOVED_AT
        defaultResourceCategoryShouldNotBeFound("removedAt.greaterThan=" + DEFAULT_REMOVED_AT);

        // Get all the resourceCategoryList where removedAt is greater than SMALLER_REMOVED_AT
        defaultResourceCategoryShouldBeFound("removedAt.greaterThan=" + SMALLER_REMOVED_AT);
    }
    ...
    void putNewResourceCategory() throws Exception {
        ...
        updatedResourceCategory.title(UPDATED_TITLE).code(UPDATED_CODE).sort(UPDATED_SORT).removedAt(UPDATED_REMOVED_AT);
        ...
        assertThat(testResourceCategory.getRemovedAt()).isEqualTo(UPDATED_REMOVED_AT);
    }
    ...
    void fullUpdateResourceCategoryWithPatch() throws Exception {
        ...
        partialUpdatedResourceCategory.title(UPDATED_TITLE).code(UPDATED_CODE).sort(UPDATED_SORT).removedAt(UPDATED_REMOVED_AT);
