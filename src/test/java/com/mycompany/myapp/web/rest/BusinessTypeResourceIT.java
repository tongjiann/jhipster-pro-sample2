...
class BusinessTypeResourceIT {
    ...
    void createBusinessType() throws Exception {
        ...
        assertThat(testBusinessType.getRemovedAt()).isEqualTo(DEFAULT_REMOVED_AT);
    }
    ...
    @Test
    @Transactional
    void getAllBusinessTypesByRemovedAtIsEqualToSomething() throws Exception {
        // Initialize the database
        businessTypeRepository.insert(businessType);

        // Get all the businessTypeList where removedAt equals to DEFAULT_REMOVED_AT
        defaultBusinessTypeShouldBeFound("removedAt.equals=" + DEFAULT_REMOVED_AT);

        // Get all the businessTypeList where removedAt equals to UPDATED_REMOVED_AT
        defaultBusinessTypeShouldNotBeFound("removedAt.equals=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllBusinessTypesByRemovedAtIsNotEqualToSomething() throws Exception {
        // Initialize the database
        businessTypeRepository.insert(businessType);

        // Get all the businessTypeList where removedAt not equals to DEFAULT_REMOVED_AT
        defaultBusinessTypeShouldNotBeFound("removedAt.notEquals=" + DEFAULT_REMOVED_AT);

        // Get all the businessTypeList where removedAt not equals to UPDATED_REMOVED_AT
        defaultBusinessTypeShouldBeFound("removedAt.notEquals=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllBusinessTypesByRemovedAtIsInShouldWork() throws Exception {
        // Initialize the database
        businessTypeRepository.insert(businessType);

        // Get all the businessTypeList where removedAt in DEFAULT_REMOVED_AT or UPDATED_REMOVED_AT
        defaultBusinessTypeShouldBeFound("removedAt.in=" + DEFAULT_REMOVED_AT + "," + UPDATED_REMOVED_AT);

        // Get all the businessTypeList where removedAt equals to UPDATED_REMOVED_AT
        defaultBusinessTypeShouldNotBeFound("removedAt.in=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllBusinessTypesByRemovedAtIsNullOrNotNull() throws Exception {
        // Initialize the database
        businessTypeRepository.insert(businessType);

        // Get all the businessTypeList where removedAt is not null
        defaultBusinessTypeShouldBeFound("removedAt.specified=true");

        // Get all the businessTypeList where removedAt is null
        defaultBusinessTypeShouldNotBeFound("removedAt.specified=false");
    }

    @Test
    @Transactional
    void getAllBusinessTypesByRemovedAtIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        businessTypeRepository.insert(businessType);

        // Get all the businessTypeList where removedAt is greater than or equal to DEFAULT_REMOVED_AT
        defaultBusinessTypeShouldBeFound("removedAt.greaterThanOrEqual=" + DEFAULT_REMOVED_AT);

        // Get all the businessTypeList where removedAt is greater than or equal to UPDATED_REMOVED_AT
        defaultBusinessTypeShouldNotBeFound("removedAt.greaterThanOrEqual=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllBusinessTypesByRemovedAtIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        businessTypeRepository.insert(businessType);

        // Get all the businessTypeList where removedAt is less than or equal to DEFAULT_REMOVED_AT
        defaultBusinessTypeShouldBeFound("removedAt.lessThanOrEqual=" + DEFAULT_REMOVED_AT);

        // Get all the businessTypeList where removedAt is less than or equal to SMALLER_REMOVED_AT
        defaultBusinessTypeShouldNotBeFound("removedAt.lessThanOrEqual=" + SMALLER_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllBusinessTypesByRemovedAtIsLessThanSomething() throws Exception {
        // Initialize the database
        businessTypeRepository.insert(businessType);

        // Get all the businessTypeList where removedAt is less than DEFAULT_REMOVED_AT
        defaultBusinessTypeShouldNotBeFound("removedAt.lessThan=" + DEFAULT_REMOVED_AT);

        // Get all the businessTypeList where removedAt is less than UPDATED_REMOVED_AT
        defaultBusinessTypeShouldBeFound("removedAt.lessThan=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllBusinessTypesByRemovedAtIsGreaterThanSomething() throws Exception {
        // Initialize the database
        businessTypeRepository.insert(businessType);

        // Get all the businessTypeList where removedAt is greater than DEFAULT_REMOVED_AT
        defaultBusinessTypeShouldNotBeFound("removedAt.greaterThan=" + DEFAULT_REMOVED_AT);

        // Get all the businessTypeList where removedAt is greater than SMALLER_REMOVED_AT
        defaultBusinessTypeShouldBeFound("removedAt.greaterThan=" + SMALLER_REMOVED_AT);
    }
    ...
    void putNewBusinessType() throws Exception {
        ...
        assertThat(testBusinessType.getRemovedAt()).isEqualTo(UPDATED_REMOVED_AT);
    }
