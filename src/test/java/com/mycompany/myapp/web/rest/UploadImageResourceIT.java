...
class UploadImageResourceIT {
    ...
    void createUploadImage() throws Exception {
        ...
        assertThat(testUploadImage.getRemovedAt()).isEqualTo(DEFAULT_REMOVED_AT);
    }
    ...
    @Test
    @Transactional
    void getAllUploadImagesByRemovedAtIsEqualToSomething() throws Exception {
        // Initialize the database
        uploadImageRepository.insert(uploadImage);

        // Get all the uploadImageList where removedAt equals to DEFAULT_REMOVED_AT
        defaultUploadImageShouldBeFound("removedAt.equals=" + DEFAULT_REMOVED_AT);

        // Get all the uploadImageList where removedAt equals to UPDATED_REMOVED_AT
        defaultUploadImageShouldNotBeFound("removedAt.equals=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllUploadImagesByRemovedAtIsNotEqualToSomething() throws Exception {
        // Initialize the database
        uploadImageRepository.insert(uploadImage);

        // Get all the uploadImageList where removedAt not equals to DEFAULT_REMOVED_AT
        defaultUploadImageShouldNotBeFound("removedAt.notEquals=" + DEFAULT_REMOVED_AT);

        // Get all the uploadImageList where removedAt not equals to UPDATED_REMOVED_AT
        defaultUploadImageShouldBeFound("removedAt.notEquals=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllUploadImagesByRemovedAtIsInShouldWork() throws Exception {
        // Initialize the database
        uploadImageRepository.insert(uploadImage);

        // Get all the uploadImageList where removedAt in DEFAULT_REMOVED_AT or UPDATED_REMOVED_AT
        defaultUploadImageShouldBeFound("removedAt.in=" + DEFAULT_REMOVED_AT + "," + UPDATED_REMOVED_AT);

        // Get all the uploadImageList where removedAt equals to UPDATED_REMOVED_AT
        defaultUploadImageShouldNotBeFound("removedAt.in=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllUploadImagesByRemovedAtIsNullOrNotNull() throws Exception {
        // Initialize the database
        uploadImageRepository.insert(uploadImage);

        // Get all the uploadImageList where removedAt is not null
        defaultUploadImageShouldBeFound("removedAt.specified=true");

        // Get all the uploadImageList where removedAt is null
        defaultUploadImageShouldNotBeFound("removedAt.specified=false");
    }

    @Test
    @Transactional
    void getAllUploadImagesByRemovedAtIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        uploadImageRepository.insert(uploadImage);

        // Get all the uploadImageList where removedAt is greater than or equal to DEFAULT_REMOVED_AT
        defaultUploadImageShouldBeFound("removedAt.greaterThanOrEqual=" + DEFAULT_REMOVED_AT);

        // Get all the uploadImageList where removedAt is greater than or equal to UPDATED_REMOVED_AT
        defaultUploadImageShouldNotBeFound("removedAt.greaterThanOrEqual=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllUploadImagesByRemovedAtIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        uploadImageRepository.insert(uploadImage);

        // Get all the uploadImageList where removedAt is less than or equal to DEFAULT_REMOVED_AT
        defaultUploadImageShouldBeFound("removedAt.lessThanOrEqual=" + DEFAULT_REMOVED_AT);

        // Get all the uploadImageList where removedAt is less than or equal to SMALLER_REMOVED_AT
        defaultUploadImageShouldNotBeFound("removedAt.lessThanOrEqual=" + SMALLER_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllUploadImagesByRemovedAtIsLessThanSomething() throws Exception {
        // Initialize the database
        uploadImageRepository.insert(uploadImage);

        // Get all the uploadImageList where removedAt is less than DEFAULT_REMOVED_AT
        defaultUploadImageShouldNotBeFound("removedAt.lessThan=" + DEFAULT_REMOVED_AT);

        // Get all the uploadImageList where removedAt is less than UPDATED_REMOVED_AT
        defaultUploadImageShouldBeFound("removedAt.lessThan=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllUploadImagesByRemovedAtIsGreaterThanSomething() throws Exception {
        // Initialize the database
        uploadImageRepository.insert(uploadImage);

        // Get all the uploadImageList where removedAt is greater than DEFAULT_REMOVED_AT
        defaultUploadImageShouldNotBeFound("removedAt.greaterThan=" + DEFAULT_REMOVED_AT);

        // Get all the uploadImageList where removedAt is greater than SMALLER_REMOVED_AT
        defaultUploadImageShouldBeFound("removedAt.greaterThan=" + SMALLER_REMOVED_AT);
    }
    ...
    void putNewUploadImage() throws Exception {
        ...
        assertThat(testUploadImage.getRemovedAt()).isEqualTo(UPDATED_REMOVED_AT);
    }
