...
class DepartmentResourceIT {
    ...
    void createDepartment() throws Exception {
        ...
        assertThat(testDepartment.getRemovedAt()).isEqualTo(DEFAULT_REMOVED_AT);
    }
    ...
    @Test
    @Transactional
    void getAllDepartmentsByRemovedAtIsEqualToSomething() throws Exception {
        // Initialize the database
        departmentRepository.insert(department);

        // Get all the departmentList where removedAt equals to DEFAULT_REMOVED_AT
        defaultDepartmentShouldBeFound("removedAt.equals=" + DEFAULT_REMOVED_AT);

        // Get all the departmentList where removedAt equals to UPDATED_REMOVED_AT
        defaultDepartmentShouldNotBeFound("removedAt.equals=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllDepartmentsByRemovedAtIsNotEqualToSomething() throws Exception {
        // Initialize the database
        departmentRepository.insert(department);

        // Get all the departmentList where removedAt not equals to DEFAULT_REMOVED_AT
        defaultDepartmentShouldNotBeFound("removedAt.notEquals=" + DEFAULT_REMOVED_AT);

        // Get all the departmentList where removedAt not equals to UPDATED_REMOVED_AT
        defaultDepartmentShouldBeFound("removedAt.notEquals=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllDepartmentsByRemovedAtIsInShouldWork() throws Exception {
        // Initialize the database
        departmentRepository.insert(department);

        // Get all the departmentList where removedAt in DEFAULT_REMOVED_AT or UPDATED_REMOVED_AT
        defaultDepartmentShouldBeFound("removedAt.in=" + DEFAULT_REMOVED_AT + "," + UPDATED_REMOVED_AT);

        // Get all the departmentList where removedAt equals to UPDATED_REMOVED_AT
        defaultDepartmentShouldNotBeFound("removedAt.in=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllDepartmentsByRemovedAtIsNullOrNotNull() throws Exception {
        // Initialize the database
        departmentRepository.insert(department);

        // Get all the departmentList where removedAt is not null
        defaultDepartmentShouldBeFound("removedAt.specified=true");

        // Get all the departmentList where removedAt is null
        defaultDepartmentShouldNotBeFound("removedAt.specified=false");
    }

    @Test
    @Transactional
    void getAllDepartmentsByRemovedAtIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        departmentRepository.insert(department);

        // Get all the departmentList where removedAt is greater than or equal to DEFAULT_REMOVED_AT
        defaultDepartmentShouldBeFound("removedAt.greaterThanOrEqual=" + DEFAULT_REMOVED_AT);

        // Get all the departmentList where removedAt is greater than or equal to UPDATED_REMOVED_AT
        defaultDepartmentShouldNotBeFound("removedAt.greaterThanOrEqual=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllDepartmentsByRemovedAtIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        departmentRepository.insert(department);

        // Get all the departmentList where removedAt is less than or equal to DEFAULT_REMOVED_AT
        defaultDepartmentShouldBeFound("removedAt.lessThanOrEqual=" + DEFAULT_REMOVED_AT);

        // Get all the departmentList where removedAt is less than or equal to SMALLER_REMOVED_AT
        defaultDepartmentShouldNotBeFound("removedAt.lessThanOrEqual=" + SMALLER_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllDepartmentsByRemovedAtIsLessThanSomething() throws Exception {
        // Initialize the database
        departmentRepository.insert(department);

        // Get all the departmentList where removedAt is less than DEFAULT_REMOVED_AT
        defaultDepartmentShouldNotBeFound("removedAt.lessThan=" + DEFAULT_REMOVED_AT);

        // Get all the departmentList where removedAt is less than UPDATED_REMOVED_AT
        defaultDepartmentShouldBeFound("removedAt.lessThan=" + UPDATED_REMOVED_AT);
    }

    @Test
    @Transactional
    void getAllDepartmentsByRemovedAtIsGreaterThanSomething() throws Exception {
        // Initialize the database
        departmentRepository.insert(department);

        // Get all the departmentList where removedAt is greater than DEFAULT_REMOVED_AT
        defaultDepartmentShouldNotBeFound("removedAt.greaterThan=" + DEFAULT_REMOVED_AT);

        // Get all the departmentList where removedAt is greater than SMALLER_REMOVED_AT
        defaultDepartmentShouldBeFound("removedAt.greaterThan=" + SMALLER_REMOVED_AT);
    }
    ...
    void putNewDepartment() throws Exception {
        ...
        assertThat(testDepartment.getRemovedAt()).isEqualTo(UPDATED_REMOVED_AT);
    }
